...
(function(App) {
    ...
    App.renderComponents = function(selector) {
        ...
        $selector.find("[data-component]").each(function(i, el) {
            var $el = $(el), component = $el.data("component"), options = $el.data("component-options"), devAssets = assetBaseUrl + "/js/app/components/" + component + ".js" + version, prodAssets = assetBaseUrl + "/js/app/components/min/" + component + ".js" + version;
            try {
...
/*! local_env equinox_maps v1.0.0 - 2015-03-02 06:03:42 */
