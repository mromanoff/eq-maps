...
(function() {
    ...
    u.j = function(a, c) {
        ...
        c = u.kc(c);
        d.W && d.W.call(a, c);
        if (e && !c.Cb() && c.bubbles !== l) u.j(e, c); else if (!e && !c.Ab() && (d = u.getData(c.target), 
        c.target[c.type])) {
            d.disabled = f;
    ...
    function E(a, c, d, e) {
        if (d !== b) return a.a.style[c] = -1 !== ("" + d).indexOf("%") || -1 !== ("" + d).indexOf("px") ? d : "auto" === d ? "" : d + "px", 
        e || a.j("resize"), a;
        if (!a.a) return 0;
        d = a.a.style[c];
        e = d.indexOf("px");
    ...
    function F(a, c) {
        ...
        j = g = d.offsetWidth;
        d = a.handle;
        if (a.g.Cd) return j = e.top, e = c.changedTouches ? c.changedTouches[0].pageY : c.pageY, 
        d && (d = d.w().offsetHeight, j += d / 2, g -= d), Math.max(0, Math.min(1, (j - e + g) / g));
        g = e.left;
    ...
    function I(a, c, d) {
        ...
        a.h = l) : "Html5" !== c && a.M && (u.l.jc(a.M), a.M = h);
        a.ia = c;
        a.aa = l;
        var e = u.k.B({
            source: d,
    ...
    t.volume = function(a) {
        if (a !== b) return a = Math.max(0, Math.min(1, parseFloat(a))), this.v.volume = a, 
        L(this, "setVolume", a), u.td(a), this;
    ...
    t.ob = function() {
        var a = u.Pb.ya;
        this.H = l;
        if (a) document[a.nb](); else this.h.Ta() ? L(this, "exitFullScreen") : (M(this), 
        this.j("fullscreenchange"));
        return this;
    };
    t.lc = function(a) {
    ...
    t.src = function(a) {
        ...
        } else a instanceof Object ? window.videojs[this.ia].canPlaySource(a) ? this.src(a.src) : this.src([ a ]) : (this.v.src = a, 
    ...
    O.H = "fullScreen") : (document.mozCancelFullScreen ? (N = "moz", O.H = N + "FullScreen") : (N = "webkit", 
    O.H = N + "IsFullScreen"), P[N + "RequestFullScreen"] && (O.wc = N + "RequestFullScreen", 
    O.nb = N + "CancelFullScreen"), O.vb = N + "fullscreenchange");
    ...
    t.e = function() {
        ...
        if (!c || this.m.movingMediaElementInDOM === l) c ? (d = c.cloneNode(l), u.l.jc(c), 
        c = d, a.M = h) : c = u.e("video", {
            id: a.id() + "_html5_api",
            className: "vjs-tech"
    ...
    u.f = u.r.extend({
        i: function(a, c, d) {
            ...
            e && (e.type && u.f.ed(e.type) ? (a = u.f.Ac(e.src), k.rtmpConnection = encodeURIComponent(a.rb), 
    ...
    function W(a, c, d) {
        for (var e = a.Aa, g = 0, j = e.length, k, q; g < j; g++) k = e[g], k.id() === c ? (k.show(), 
    ...
    function X(a) {
        0 === a.ha && a.load();
        0 === a.ga && (a.b.d("timeupdate", u.bind(a, a.update, a.Q)), a.b.d("ended", u.bind(a, a.reset, a.Q)), 
        ...
        if (0 < this.fa.length) {
            ...
            if (this.Lb === b || a < this.Lb || this.Ma <= a) {
                ...
                for (;;) {
                    ...
                    } else g ? (j.splice(0, 0, n), q === b && (q = r), k = r) : (j.push(n), k === b && (k = r), 
                    q = r), d = Math.min(d, n.va), e = Math.max(e, n.startTime), n.Ia = f;
    ...
    t.Ka = function() {
        for (var a = V(this.b), c = 0, d = a.length, e, g, j = this.I = []; c < d; c++) if (e = a[c], 
        e.J() == this.A && e.ub()) {
            if (2 > e.readyState()) {
                this.Id = e;
    ...
    u.fc = function() {
        ...
        a !== h && (a = u.JSON.parse(a || "{}"), v(c, a))); else {
            u.kb();
            break;
        } else u.Ec || u.kb();
    };
...
(function(factory) {
    if (typeof exports == "object") {
        module.exports = factory(module.exports, require("underscore"), require("backbone"));
    ...
    PercentFormatter.prototype = new Backgrid.NumberFormatter(), _.extend(PercentFormatter.prototype, {
...
(function(root, factory) {
    if (typeof exports == "object") {
        module.exports = factory(require("underscore"), require("backbone"), require("backgrid"), require("backbone.paginator"));
    }
    if (typeof define === "function" && define.amd) {
    ...
    var Paginator = Backgrid.Extension.Paginator = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            _.extend(self, _.pick(options || {}, "windowSize", "pageHandle", "slideScale", "goBackFirstOnSort", "renderIndexedPageHandles"));
            ...
            self.listenTo(col, "backgrid:sorted", function() {
                if (self.goBackFirstOnSort) col.getFirstPage({
                    reset: true
                });
            });
        },
...
typeof JSON != "object" && (JSON = {}), function() {
        ...
        switch (typeof a) {
          ...
          case "object":
            ...
            if (rep && typeof rep == "object") {
                s = rep.length;
                for (n = 0; n < s; n += 1) typeof rep[n] == "string" && (r = rep[n], i = str(r, a), 
                i && u.push(quote(r) + (gap ? ": " : ":") + i));
            } else for (r in a) Object.prototype.hasOwnProperty.call(a, r) && (i = str(r, a), 
            i && u.push(quote(r) + (gap ? ": " : ":") + i));
            return i = u.length === 0 ? "{}" : gap ? "{\n" + gap + u.join(",\n" + gap) + "\n" + o + "}" : "{" + u.join(",") + "}", 
            gap = o, i;
        }
    ...
    typeof JSON.stringify != "function" && (JSON.stringify = function(e, t, n) {
        ...
        function walk(e, t) {
            var n, r, i = e[t];
            if (i && typeof i == "object") for (n in i) Object.prototype.hasOwnProperty.call(i, n) && (r = walk(i, n), 
    ...
    n.Adapter = {
        ...
        bind: function(e, t, r) {
            ...
            n.Adapter.handlers[i][t].push(r), e["on" + t] = function(e, t) {
                return function(r) {
    ...
    h.init = function(e) {
        ...
        typeof h.initHtml4 != "undefined" && h.initHtml4(), !0);
    }, h.initCore = function(d) {
        if (typeof h.initCore.initialized != "undefined") return !1;
        h.initCore.initialized = !0, h.options = h.options || {}, h.options.hashChangeInterval = h.options.hashChangeInterval || 100, 
        ...
        h.options.delayInit = h.options.delayInit || !1, h.intervalList = [], h.clearAllIntervals = function() {
            ...
            return e.length === 1 && (t = e[0], n = t.href.replace(/[^\/]+$/, "")), n = n.replace(/\/+$/, ""), 
            n && (n += "/"), n;
            ...
            return t = typeof t == "undefined" ? !0 : t, /[a-z]+\:\/\//.test(e) || (r === "/" ? n = h.getRootUrl() + e.replace(/^\/+/, "") : r === "#" ? n = h.getPageUrl().replace(/#.*/, "") + e : r === "?" ? n = h.getPageUrl().replace(/[\?#].*/, "") + e : t ? n = h.getBaseUrl() + e.replace(/^(\.\/)+/, "") : n = h.getBasePageUrl() + e.replace(/^(\.\/)+/, "")), 
            n.replace(/\#$/, "");
        ...
        h.normalizeStore = function() {
            ...
            return t = {}, t.normalized = !0, t.title = e.title || "", t.url = h.getFullUrl(e.url ? e.url : h.getLocationHref()), 
            ...
            var t, n, r, i;
            return e.indexOf("#") != -1 ? i = e.split("#")[0] : i = e, n = /(.*)\&_suid=([0-9]+)$/.exec(i), 
            ...
            return typeof e == "function" && (e = {
                callback: e
            }), typeof t != "undefined" && (e.queue = t), h.busy() ? h.pushQueue(e) : h.fireQueueItem(e), 
            h;
            ...
            if (!h.isLastSavedState(t)) return n = t, n || (n = h.createStateObject()), h.Adapter.trigger(e, "popstate"), 
            h;
            return;
        }, h.back = function(e) {
...
$.fn.simpleTabs = function(options) {
    ...
    function switchTabContent(tabs, tabLink) {
        ...
        if (!animating && !tab.hasClass("active")) {
            tabClicked = tabLink.attr("href").replace("#", "");
            tabs.find(".tabs-nav").find(".active").removeClass("active");
            tab.addClass("active");
...
(function($) {
    function triggerEvent($elem, eventType, event, relatedTarget) {
        var originalType = event.type, originalEvent = event.originalEvent, originalTarget = event.target, originalRelatedTarget = event.relatedTarget;
        event.target = $elem[0];
    ...
    $.fn.forwardevents = function(settings) {
        ...
        var instance = this;
        return this.each(function() {
            var $this = $(this), xy, lastT, clickX, clickY, clicks = 0, lastClick = 0;
            $this.bind("mouseout", function(e) {
                ...
                if ($this.is(":visible")) {
                    var be = e.originalEvent, et = be.type, mx = be.clientX, my = be.clientY, t;
                    e.stopPropagation();
...
$.fn.selectWrapper = function(options) {
    ...
    return this.each(function() {
        var html = "", $this = $(this), $select = $this.find("select");
        function bindings() {
...
/*! local_env equinox_maps v1.0.0 - 2015-03-01 05:03:23 */
