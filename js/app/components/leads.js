    ...
    App.Components['leads'] = function ($el) {
        ...
        SAV.Step1.Submit = function () {
            ...
            $el.find('.submit').on('click', function (e) {
                ...
                var InterestsVal = $el.find('input[type=checkbox]:checked').map(function () { return this.id; }).get().join(',');
                ...
                function getCheckedId(index) {
                    return $el.find('input[type=checkbox]:checked').eq(index).map(function () { return this.id; });
                }
        ...
        SAV.Step2.Submit = function () {
            ...
            $el.find('.submit').on('click', function (e) {
                ...
                $el.find('.row').each(function () {
                    ...
                    function getCheckedId(index) {
                        return $answerOptions.find(':checked').eq(index).map(function () { return $(this).data('value'); });
                    }
