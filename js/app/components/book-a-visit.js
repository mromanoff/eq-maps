(function (global, App) {
    'use strict';
    /* global Crittercism, EQ */

    /**
     * Schedule a visit  module .
     */
    ...
    App.Components['book-a-visit'] = function ($el) {
        ...
        SAV.Validate = function () {
            var $firstName = $el.find('.first-name'),
                ...
                $club = $el.find('.club'),
                $interest = $el.find('#interest'),
                $fitness = $el.find('#fitness'),
                $email = $el.find('.email'),
                $phone = $el.find('.phone');
        ...
        SAV.Submit = function () {
            var ENDPOINT_URL = '/leads/step1'; //'/esb/scheduleavisit';
            ...
            $el.find('.submit').on('click', function (e) {
                ...
                //<questionsAnswers>
                //   <QuestionAnswers>
                //      <questionText>I'm interested in:</questionText>
                //      <answers>
                //         <Answer>
                //            <answerText>Athletic Training</answerText>
                ...
                //questionText = '<questionText>' + $el.find('.question').text() + '</questionText>';
                //qa = '<QuestionAnswers>' + questionText + answerArr + '</QuestionAnswers>';
