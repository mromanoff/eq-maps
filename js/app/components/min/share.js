(function(App) {
    ...
    var SocialSharingContainerView = Backbone.View.extend({
        ...
        twSharing: function(e) {
            e.preventDefault();
            var twText, TwitterURL, twClassDate = moment(this.options.classdate).format("MMMM DD [at] h:mma"), twitterCases = {
    ...
    var FBSharingModalView = Backbone.View.extend({
        ...
        share: function(e) {
            e.preventDefault();
            var that = this, fbObject, fbEndPoint, textAreaVal = that.$el.find("textarea").val(), model = that.options.model, objectSharedWithFacebook = {}, fbCases = {
                "join-class": {
                    action: "join",
                    objectName: "class"
                },
            ...
            var fbObjectName = fbCases[this.options.type].objectName, fbActionName = fbCases[this.options.type].action;
            fbObject = {
            ...
            FB.api("me/" + fbEndPoint, "post", objectSharedWithFacebook, function(response) {
