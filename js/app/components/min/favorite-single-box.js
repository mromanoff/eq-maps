(function(global, App) {
    ...
    var FavoriteContainerView = Backbone.View.extend({
        ...
        addNewItem: function(item) {
            var that = this, favoriteItemView, $editModeButton = this.$el.find(".edit-mode");
            $editModeButton.addClass("hidden");
        ...
        removeItem: function(itemModel) {
            ...
            var that = this, deleteEndPoint = APIEndpoint + "/me/favorites/" + itemModel.get("type") + "/remove/" + itemModel.get("id");
        ...
        render: function() {
            var that = this, $favoritesClasses = this.$el.find(".favoritesSelectorComponent"), $loaderContainer = this.$el.find(".loader-container");
            this.renderFavList();
            ...
            App.loadComponent(this.options.componentName, $favoritesClasses, this.options.componentOptions);
    ...
    FavoriteBox.init = function($el, options) {
        var favoriteContainerView, itemsCollection = new ItemsCollection(options.data), name = options.name || "";
