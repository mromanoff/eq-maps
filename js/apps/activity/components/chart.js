        ...
        draw: function(){
            ...
            if (this.display){
                ...
                if (this.showAxisLabels) {
                    ...
                    ctx.fillText(this.yLabel,xStart -10,this.startPoint - 25);
                    ctx.fillText(this.xLabel,xStart -10,this.endPoint + 22);
                    ctx.restore();
                }
                ...
                helpers.each(this.xLabels,function(label,index){
                    ...
                    ctx.translate(xPos, this.endPoint + 15);
                    ctx.font = this.font;
    ...
    Chart.SquareTooltip = Chart.Tooltip.extend({
        draw : function(){
            ...
            var titleWidth = ctx.measureText(this.title).width,
                ...
                textWidth = textWidth < titleWidth ? titleWidth : textWidth,
                tooltipWidth = textWidth + 2*this.xPadding,
                tooltipRectHeight = this.fontSize + 1.7*this.yPadding + this.fontTitleSize - this.lineSpacing,//Looks better
