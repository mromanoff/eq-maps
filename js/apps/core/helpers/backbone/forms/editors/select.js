define(function (require, exports, module) {
    ...
    var SelectTemplate     = require('text!core/templates/forms/select.tpl');
    ...
    Backbone.Form.editors.Select = Backbone.Form.editors.Base.extend({
        ...
        updateFancySelect: function() {
            ...
            this.$el.find('.option').text(val);

            this.value = val;              // for backbone-forms data submitted
            this.setValue(val);            // for validator
            this.model.set(this.key, val); // for backbone-forms data submitted
        },
        ...
        render: function() {
            ...
            $el.find('[data-editor]').append(this.$el);

            this.$el.closest('.fancy-select').addClass(this.options.schema.theme || 'white');
