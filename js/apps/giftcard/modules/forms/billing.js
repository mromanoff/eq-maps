define(function (require, exports, module) {
    ...
    Billing.Templates.select = _.template('<div><span data-editor class="dropdown block white"><span class="option"><%= title %></span></span></div>');
    ...
    Billing.Form = Forms.extend({
        ...
        template: _.template($('#tplPaymentInfoForm').html()),
        schema: {
            nameOnCard: {
                title: '',
                fieldClass: 'full',
            ...
            updateTermsCondition: {
                ...
                validators: [
                        function validateField(value) {
                            if (!_.isEmpty(window.user) && !value)
                            {
                                return 'error';
                            }
                        }]
