...
consts.APP = consts.APPS + '/giftcard';
...
consts.MOCKS = consts.API;
consts.ROOT = '/gift-card/purchase';
consts.HOME = '/';
requirejs.config({
    ...
    paths: {
        ...
        'backbone.validation': consts.BOWER + '/backbone-validation/dist/backbone-validation-amd-min',
