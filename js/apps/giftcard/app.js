...
define(function (require) {
    ...
    var RecipientInfoModel = require('modules/recipient_info');
    var TransactionModel = require('modules/transaction');
    var ReviewOrderModel = require('modules/review_order');
    var GiftcardResponseModel = require('modules/giftcard_response');
    ...
    var App = {
        ...
        envConfig: EnvConfig,
        store: {
            recipientInfoModel: new RecipientInfoModel(),
            transactionModel: new TransactionModel(),
            reviewOrderModel: new ReviewOrderModel(),
            giftcardResponseModel: new GiftcardResponseModel(),
            isRefreshed: true
        },
        setHeader: function (xhr) {
            xhr.setRequestHeader('eqx-token', '=0ljKFA3adSdzhP/16lCPwRDt7WoX+JQlM0eDyAp7q/I=');
