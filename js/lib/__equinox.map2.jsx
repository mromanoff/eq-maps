(function (global) {
    ...
    var CALLBACK_NAME = 'googleMapsLoadedCallback' + (+new Date()),
        MAPS_API_URL = function (callback) {
    ...
    // Library namespace
        ...
        Map = function (container, extra) {
            ...
            var options = {
                center: new google.maps.LatLng(0, 0),  // default lat lng 41.850033, -87.6500523 it could be just 0, 0
                panControl: false,
                styles: googleMapStyles,
                zoom: 9,
                minZoom: 9,
            ...
            //
            //for(var i = 0; i < selectedRegion.Facilities.length; i++) {
            //    markerLatLng = new google.maps.LatLng(selectedRegion.Facilities[i].Latitude, selectedRegion.Facilities[i].Longitude);
            //    //marker = new google.maps.Marker({
            //    marker = new RichMarker({
            //        position: markerLatLng,
            //        title: selectedRegion.Facilities[i].ClubName,
            //        map: map,
            //        flat: true,
            ...
            //google.maps.event.addListener(marker, 'click', setMarker);
    ...
    Map.prototype = {
        ...
        init: function () {
            ...
            //TODO:MR remove this. it is deprecated
